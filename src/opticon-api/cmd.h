...
int cmd_login (req_context *, req_arg *, var *, int *);
int cmd_user_set (req_context *, req_arg *, var *, int *);
int cmd_user_delete (req_context *, req_arg *, var *, int *);
...
int cmd_host_get_external (req_context *, req_arg *, var *, int *);
...
int cmd_host_list_graphs (req_context *, req_arg *, var *, int *);
int cmd_host_get_graph (req_context *, req_arg *, var *, int *);
